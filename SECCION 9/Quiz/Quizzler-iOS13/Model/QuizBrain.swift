...
struct QuizBrain {
    ...
    mutating func updateAlternative(){
        altA = quiz[questionNumber].answer[0]
        altB = quiz[questionNumber].answer[1]
        altC = quiz[questionNumber].answer[2]
